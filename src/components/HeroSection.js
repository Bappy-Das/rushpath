        ...
        <div className="container mx-auto xl:px-32">
          <div className="pt-12 ">
            <div className="lg:mt-0">
              <h1 className="text-xl text-center md:text-2xl xl:text-3xl font-bold tracking-wide mb-12 text-curious-blue-500">
                  Unleash Your Inner Genius !
              </h1>
              <h1 className="text-2xl text-center md:text-3xl xl:text-4xl font-bold tracking-wide mb-12 text-curious-blue-500">
                  Beyond Textbooks !
              </h1>
              <h1 className="text-2xl text-center md:text-3xl xl:text-4xl font-bold tracking-wide mb-12 text-curious-blue-500">
                  Don't Just Read, Play !
              </h1>
              <h1 className="text-4xl font-class-brick tracking-wide text-center md:text-5xl xl:text-6xl font-bold mb-12 text-curious-blue-500">
