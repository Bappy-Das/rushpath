        ...
        <div className='bg-white'>
            <div className="mx-auto w-full max-w-screen-xl p-4 md:py-20 lg:py-20">
                <div className='flex justify-center flex-col gap-4'>
                    ...
                    <h1 className='text-[#F5C11D] text-xl font-bold'>Our Mission : </h1> 
                    <p>Make learning entertaining for everyone, from school students to university whizzes and industry professionals.</p>
                    <h1 className='text-[#F5C11D] text-xl font-bold'>Level Up Your Skills! </h1>
                    ...
                    <h1 className='text-[#F5C11D] text-xl font-bold'>Learning Never Stops!</h1>
