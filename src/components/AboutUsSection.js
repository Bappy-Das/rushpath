            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 md:py-20 lg:py-20">
                <div className='flex justify-center flex-col gap-4'>
                    <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold font-class-brick mb-12 rushpath_secondary">
                        Rushpath: Where learning is entertaining!
                    </h1>
                    ...
                    <p>Rushpath offers a variety of games across different subjects, from arts and science to math, biology, chemistry, physics, management and more!  We cater to all learning levels, helping you build a foundation in core concepts and progress to mastery.</p>
